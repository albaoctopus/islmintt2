    ...
    <>
      <div className="h-[55vh] grid items-center justify-items-center bg-black border border-slate-700 relative rounded-md">
        <div className="grid items-center justify-items-center text-center opacity-100 z-[1700]">
            <h1 className="text-5xl lg:text-4xl md:text-3xl sm:text-2xl font-bold text-slate-300">ISL NFT</h1>
            <h1 className="text-5xl lg:text-4xl md:text-3xl sm:text-2xl font-bold text-slate-300">Collection is live now!</h1>
            <p className="my-5 text-slate-400 text-sm sm:text-xs w-[50vw] lg:w-11/12">This NFT will allow you to be in touch with ISL team and have a special benefits and unique experience by communicating with the athlete.</p>
